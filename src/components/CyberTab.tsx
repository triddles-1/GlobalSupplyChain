...
export default function CyberTab({ alerts, suppliers }: CyberTabProps) {
  ...
  return (
    <div className="space-y-6 font-sans">
      {/* Intro Header */}
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-white font-sans">Cyber Threat intelligence Center</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-5 relative overflow-hidden">
          <span className="text-[10px] font-semibold uppercase tracking-wider text-slate-500 block">Average Cyber Resilience</span>
        ...
        <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-5 relative overflow-hidden">
          <span className="text-[10px] font-semibold uppercase tracking-wider text-slate-500 block">High Cyber Risk Vendors</span>
          <div className="mt-2.5 flex items-baseline gap-2">
        ...
        <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-5 relative overflow-hidden">
          <span className="text-[10px] font-semibold uppercase tracking-wider text-slate-500 block">Active Cyber Campaigns</span>
          <div className="mt-2.5 flex items-baseline gap-2">
            <span className="text-3xl font-bold text-amber-400 tracking-tight">{cyberAlerts.length}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 space-y-4">
          <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Active Threat Feeds</h2>
          {cyberAlerts.map(alert => (
            <div key={alert.id} className="p-5 bg-slate-900 border border-slate-800 rounded-2xl flex gap-4">
              ...
              <div className="min-w-0 flex-1 space-y-1">
                <div className="flex items-center justify-between gap-3">
                  <span className="font-bold text-sm text-white truncate">{alert.title}</span>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-5 space-y-4">
            ...
            <div className="space-y-3">
              {activeCVEs.map((item) => (
                <div key={item.cve} className="p-2.5 bg-slate-950 rounded-xl border border-slate-800/50 space-y-1">
                  ...
                  <div className="flex justify-between items-center text-[9px] font-semibold uppercase tracking-wider pt-1 mt-1 border-t border-slate-900">
          ...
          <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-5 space-y-3">
            <h3 className="text-sm font-semibold text-slate-200">Vendor Compliance Criteria</h3>
            ...
            <div className="space-y-2.5 pt-1 text-xs text-slate-300">
              <label className="flex items-center gap-2.5 cursor-pointer">
                <input type="checkbox" defaultChecked disabled className="rounded accent-blue-500 bg-slate-950" />
              ...
              <label className="flex items-center gap-2.5 cursor-pointer">
                <input type="checkbox" defaultChecked={false} disabled className="rounded accent-blue-500 bg-slate-950" />
